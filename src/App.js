...
class App extends Component {
  ...
  performSearch(searchKey){
    ...
    const urlString = "https://api.themoviedb.org/3/search/movie?api_key=9f4518c7e38c5da9c1aed6830d5e42e3&language=en-US&page=1&include_adult=false&query=" + searchKey
    $.ajax({
        url: urlString,
